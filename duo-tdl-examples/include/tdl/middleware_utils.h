...
/**
 * @brief initialize VI using the manual diagnostic path only.
 * @param pstViConfig VI configuration
 * @return CV_S32 return CVI_SUCCESS if initialize VI successfully, otherwise return error
 * code instead.
 */
